...
import { ExceptionHandlerPublisher } from '../publishers/exception-handler/ExceptionHandlerPublisher';
...
export abstract class Listener<T = any> {
    ...
    abstract onMessage(data: T, type: string, msg: ConsumeMessage): void;
    channel: Channel;
    ...
    isValidEventData(value: any, schema: ValidationSchema, msg: amqp.ConsumeMessage) {
